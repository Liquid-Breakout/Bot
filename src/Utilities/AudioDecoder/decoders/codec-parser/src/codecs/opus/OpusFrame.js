...
function _getPrototypeOf(o) { _getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf.bind() : function _getPrototypeOf(o) { return o.__proto__ || Object.getPrototypeOf(o); }; return _getPrototypeOf(o); } /* Copyright 2020-2023 Ethan Halsall
                                                                                                                                                                                                                     ...
                                                                                                                                                                                                                     */
var OpusFrame = /*#__PURE__*/function (_CodecFrame) {
  _inherits(OpusFrame, _CodecFrame);
  var _super = _createSuper(OpusFrame);
  function OpusFrame(data, header) {
    _classCallCheck(this, OpusFrame);
    return _super.call(this, header, data, header[_constants.frameSize] * header[_constants.frameCount] / 1000 * header[_constants.sampleRate]);
  }
  return _createClass(OpusFrame);
