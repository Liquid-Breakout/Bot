...
function enableLibInt(bass, libname) {
    ...
    bass.libFiles[libname].enable(ffi.Library(new ffi.DynamicLibrary(bass.libFiles[libname].path, ffi.DynamicLibrary.FLAGS.RTLD_NOW | ffi.DynamicLibrary.FLAGS.RTLD_GLOBAL), ffiFunDeclaration));
