...
function wrapReader(dbName, readerInitializer, autoUpdater) {
    ...
    get: function get(_, prop) {
      if (prop === 'close') {
        return function () {
          ...
          (_a = reader.close) === null || _a === void 0 ? void 0 : (_a2 = _a).call.apply(_a2, [reader].concat(args));
        };
      }
      return reader[prop];
    },
  ...
  return new Promise(function (resolve) {
    autoUpdater.once('check-ok', /*#__PURE__*/function () {
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              dbPath = paths[dbName];
              _context2.next = 3;
              return readerInitializer(dbPath);
            case 3:
              reader = _context2.sent;
              setImmediate(function () {
                autoUpdater.on('updated', /*#__PURE__*/function () {
                  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(paths) {
                    var dbPath;
