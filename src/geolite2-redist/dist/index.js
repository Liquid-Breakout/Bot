...
*/
function downloadDbs(_x) {
  return _downloadDbs.apply(this, arguments);
}
/**
...
*/
function _downloadDbs() {
  _downloadDbs = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(options) {
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return (0, _downloadHelpers.verifyChecksums)(options === null || options === void 0 ? void 0 : options.dbList, options === null || options === void 0 ? void 0 : options.path);
        case 3:
          _context.next = 11;
          break;
        case 5:
        ...
        case 9:
          _context.next = 11;
          return (0, _downloadHelpers.downloadDatabases)(options === null || options === void 0 ? void 0 : options.dbList, options === null || options === void 0 ? void 0 : options.path);
        case 11:
        case "end":
...
function open(_x2, _x3, _x4) {
  return _open.apply(this, arguments);
}
function _open() {
  _open = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(dbName, readerInitializer, downloadDirPath) {
    var autoUpdater, wrappedReader;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          autoUpdater = new _autoUpdater.AutoUpdater([dbName], downloadDirPath);
          _context2.next = 3;
          return (0, _readerWrapper.wrapReader)(dbName, readerInitializer, autoUpdater);
        case 3:
          wrappedReader = _context2.sent;
          return _context2.abrupt("return", wrappedReader);
        case 5:
        case "end":
