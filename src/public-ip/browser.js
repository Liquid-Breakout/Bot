...
var sendXhr = function sendXhr(url, options, version) {
  ...
  var promise = new Promise(function (resolve, reject) {
    ...
    xhr.addEventListener('load', function () {
      ...
      var method = version === 'v6' ? _isIp.isIPv6 : _isIp.isIPv4;
      if (!ip || !method(ip)) {
        reject();
        return;
      }
...
var queryHttps = function queryHttps(version, options) {
  ...
  var promise = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var _options$fallbackUrls;
    var urls_, lastError, _iterator, _step, url, ip;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          urls_ = [].concat(_toConsumableArray(urls[version]), _toConsumableArray((_options$fallbackUrls = options.fallbackUrls) !== null && _options$fallbackUrls !== void 0 ? _options$fallbackUrls : []));
