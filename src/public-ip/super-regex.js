...
var _functionTimeout = _interopRequireWildcard(require("./utils/function-timeout/index.js"));
var _timeSpan = _interopRequireDefault(require("./utils/time-span/index.js"));
var _cloneRegexp = _interopRequireDefault(require("./utils/clone-regexp.js"));
...
function matches(regex, string) {
  ...
  return _defineProperty({}, Symbol.iterator, /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var _matches, nextMatch, end, _nextMatch, value, done;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _matches = string.matchAll(regex); // The regex is only executed when iterated over.
        case 2:
          if (!true) {
            _context.next = 13;
            break;
        ...
        case 15:
          ...
          if ((0, _functionTimeout.isTimeoutError)(_context.t0)) {
            _context.next = 19;
            break;
          }
          throw _context.t0;
